...
// import WordDisplay from './view/components/wordDisplay'
  ...
  return (
    <div className="App">
      <header className="App-header">
        {/* <div> <TextInput /> </div> */}
        <div id='statitics'>
          <p id="totalWords">Total Words Typed:0</p>
          <p id="correctWords">Number of Correct Words:0</p>
          <p id="errors">Number of Errors:0</p>
          <p id="speed">Latest Words per Minutes:0</p>
          </div>
          <div id='keyBoard'>
            <div id='topRow'>
